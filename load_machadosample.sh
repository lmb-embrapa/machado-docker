...
docker-compose exec machado python manage.py load_feature_annotation --file data/sample/genomes/Athaliana_167_TAIR10.defline.ChrM.txt --soterm mRNA --cvterm display --organism 'Arabidopsis thaliana'
docker-compose exec machado python manage.py load_feature_annotation --file data/sample/genomes/Athaliana_167_TAIR10.defline.ChrM.txt --soterm polypeptide --cvterm display --organism 'Arabidopsis thaliana'
