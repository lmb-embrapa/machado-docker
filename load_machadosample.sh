...
docker-compose exec machado python manage.py load_fasta --file data/sample/genomes/Athaliana_167_TAIR9.chrM.fa --soterm chromosome --organism 'Arabidopsis thaliana' --nosequence
